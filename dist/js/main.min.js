(() => {
  ...
  function swiperInit() {
    ...
    $(".init-swiper .swiper").each(function(index) {
      ...
      const playOnView = $this.hasClass("play-on-view") || $this.closest(".init-swiper").hasClass("play-on-view");
