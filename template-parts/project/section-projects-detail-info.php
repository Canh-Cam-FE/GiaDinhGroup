						...
						<div class="list flex flex-col clamp:gap-[24-24]">
							<?php if ($location) : ?>
								<div class="item flex flex-col clamp:gap-[4-4]">
									<div class="desc body-2 text-white label font-bold"><?php echo esc_html__('Vị trí', 'canhcamtheme'); ?></div>
									<div class="desc body-2 text-white"><?php echo esc_html($location); ?></div>
								</div>
							<?php endif; ?>
							<?php if ($investor) : ?>
								<div class="item flex flex-col clamp:gap-[4-4]">
									<div class="desc body-2 text-white label font-bold"><?php echo esc_html__('Chủ đầu tư', 'canhcamtheme'); ?></div>
							...
							<?php if ($scale || $handover) : ?>
								<div class="inner flex items-center clamp:gap-[52-52]">
									<?php if ($scale) : ?>
										<div class="item flex flex-col clamp:gap-[4-4]">
											<div class="desc body-2 text-white label font-bold"><?php echo esc_html__('Quy mô', 'canhcamtheme'); ?></div>
									...
									<?php if ($handover) : ?>
										<div class="item flex flex-col clamp:gap-[4-4]">
											<div class="desc body-2 text-white label font-bold"><?php echo esc_html__('Thời gian bàn giao', 'canhcamtheme'); ?></div>
