		...
		<div class="wrap flex flex-wrap items-center clamp:gap-[16-24] mb-10 lg:justify-between max-lg:mb-7">
			...
			<div class="zone-nav">
				<ul class="list flex flex-wrap items-center clamp:gap-[16-16]" role="tablist"
					aria-label="<?php echo esc_attr__('Danh mục dự án', 'canhcamtheme'); ?>"
					data-js-target="projects-filter">
					<li>
						<a href="<?php echo esc_url($all_url); ?>">
							<span
								class="desc body-1 <?php echo $is_all_active ? 'text-primary-2' : 'text-gray-950'; ?>">
				...
				<div class="row">
					...
					<div class="col w-full lg:w-5/12">
						<div class="content">
							<div class="wrap">
								<h3>
									<a class="group-hover:text-primary-2 heading-3 text-gray-950"
								...
								<div class="box">
									<?php if ($location): ?>
										<div class="item">
											<div class="desc body-2 text-gray-950 label font-bold">
