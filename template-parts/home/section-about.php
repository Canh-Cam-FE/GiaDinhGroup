		...
		<div class="row gap-10 lg:gap-16">
			...
			<div class="col w-full lg:w-1/2">
				<div
					...
					<?php endif; ?>
					<?php if ($button_1): ?>
					<a href="<?php echo esc_url($button_1['url']); ?>" class="btn btn-primary"
						<?php if (!empty($button_1['target'])): ?>target="<?php echo esc_attr($button_1['target']); ?>"
						<?php endif; ?>>
		...
		<div class="row gap-10 lg:gap-16">
			...
			<div class="col w-full lg:w-1/2">
				<div
					...
					<?php endif; ?>
					<?php if ($button_2): ?>
					<a href="<?php echo esc_url($button_2['url']); ?>" class="btn btn-primary"
						<?php if (!empty($button_2['target'])): ?>target="<?php echo esc_attr($button_2['target']); ?>"
						<?php endif; ?>>
